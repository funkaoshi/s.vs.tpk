...
[In my Carcosa style recap of the session][s9], one of my fictional alternative endings to the session was as follows:
...
They were first mentioned in the [session 7 recap][s7], and I likely added them as an entry on the encounter table for the region shortly after. The players would meet them a few sessions later. As I mentioned earlier, I would sometimes use the recaps as a way to share rumours, and also share news about the off camera world with the players. In the [session 8 recap][s8] I shared that the Bone Men cultists were taking people back to an Abandoned Space Alien Outpost. The players would eventually return there, but I don’t think it was because of the mention in that recap. This is probably too subtle a way to share what’s going on, but it was a fun all the same. 
...
- [Beloch Shrike][nick]: Renoir, Red Man Fighter
- [Gus][]: Normangina 
...
[s7]: /masters-of-carcosa/session-7/
[s8]: /masters-of-carcosa/session-8/
[s9]: /masters-of-carcosa/session-9/
